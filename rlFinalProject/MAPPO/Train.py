...
def train():
    ...
    MAPPOagent = MAPPO(state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip,
    ...
    while time_step <= max_training_timesteps:
        ...
        for t in range(1, max_ep_len + 1):
            ...
            action1, action2 = MAPPOagent.select_action(state1, state2)
            action1 = torch.clamp(action1, -0.5, 0.5)
            action2 = torch.clamp(action2, -0.5, 0.5)
            ...
            MAPPOagent.buffer1.rewards.append(rews1)
            MAPPOagent.buffer2.rewards.append(rews1)

            MAPPOagent.buffer1.is_terminals.append(bool(done[0]))
            MAPPOagent.buffer2.is_terminals.append(bool(done[0]))
            ...
            if has_continuous_action_space and time_step % action_std_decay_freq == 0:
                MAPPOagent.decay_action_std(action_std_decay_rate, min_action_std)
...
if __name__ == '__main__':
    ...
    np.save('./MAPPOwheel.npy', finalSave)
